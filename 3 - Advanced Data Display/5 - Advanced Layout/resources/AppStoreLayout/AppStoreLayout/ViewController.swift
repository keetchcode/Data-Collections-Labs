...
class ViewController: UIViewController {
  ...
  func createLayout() -> UICollectionViewLayout {
    ...
    let layout = UICollectionViewCompositionalLayout { sectionIndex, layoutEnvironment -> NSCollectionLayoutSection? in
      ...
      case .promoted:
        ...
        // Add spacing between each item cell
        ...
        // this section.property here is how you modify the scrolling behavior of your section
      ...
      case .categories:
        ...
        // MARK: Categories Layout Section
        ...
        let groupSize = NSCollectionLayoutSize(widthDimension: .fractionalHeight(1.0), heightDimension: .estimated(44))
  ...
  func configureDataSource() {
    ...
    let promotedAppCellRegistration = UICollectionView.CellRegistration<PromotedAppCollectionViewCell, Item.ID> { cell, indexPath, itemIdentifier in
      ...
      guard let item = Item.promotedApps.first(where: { $0.id == itemIdentifier }) else {
        return }
    ...
    // This gives our collection view all the data it needs
