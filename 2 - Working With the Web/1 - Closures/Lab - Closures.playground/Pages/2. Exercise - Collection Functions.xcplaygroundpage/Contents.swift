...
let result = forwards(name1: "Wes", name2: "Wesley")
print(result)

//forwards(name1: "Wesley Keetch Full Name", name2: "Wesley Keetch")
//forwards(name1: "Full name", name2: "Name")
...
let names: [String] = ["Wes", "Carl", "Abe", "Bob", "Rex", "Joe"]
